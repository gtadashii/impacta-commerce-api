...
[
  {
    ...
    'tumbnailUrl': 'http://meu-ecommerce.com/img/pt/tb-pers-porc.jpg',
    'qty': 1,
    'unitPrice': 123.45
  },
  {
    ...
    'tumbnailUrl': 'http://meu-ecommerce.com/img/pt/tb-import-colors.jpg',
    'qty': 2,
    'unitPrice': 123.45
  },
  {
    ...
    'tumbnailUrl': 'http://meu-ecommerce.com/img/pt/tb-tuli.jpg',
    'qty': 1,
    'unitPrice': 123.45
  }
]
...
def get(cart_code=None):
    '''
    Lista tados os carts ou exibe os detalhes de um único cart quando código
    é informado
    '''
